...
export const getAllCartItems = (reqData) => {
    return async (dispatch) => {
        ...
        try {
            const response = await api.get(`${API_URL}/api/carts/${reqData.cartId}/items`,{
                headers: {
...
export const updateCartItem= (reqData) => {
    return async (dispatch) => {
        ...
        try {
            const {data} = await api.put(`${API_URL}/api/cart-item/update`,reqData.data,{
                headers: {
...
export const removeCartItem= ({cartItemId,jwt}) => {
    return async (dispatch) => {
        ...
        try {
            const {data} = await api.delete(`${API_URL}/api/cart-item/${cartItemId}/remove`,{
                headers: {
